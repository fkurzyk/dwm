...
static const char col_accent[]      = "#99cc00";
static const char col_inactive[]    = "#666633";
static const char *colors[][3]      = {
	/*               fg         bg            border   */
//	[SchemeNorm] = { col_gray3, col_gray1,    col_gray1 },
//	[SchemeSel]  = { col_gray4, col_accent,   col_accent  },
	[SchemeNorm] = { col_gray3, col_inactive, col_inactive },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_inactive, "-nf", col_gray3, "-sb", col_accent, "-sf", col_white, NULL };
